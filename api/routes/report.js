...
router.post("/normal/add", (req, res) => {
  ...
  var sql =
    "INSERT INTO commodity_report (report1,report2,commodityid,shopid) VALUES ('" +
    report1 +
    "','" +
    report2 +
    "','" +
...
router.get("/shop/getlist/:shopid", (req, res) => {
  ...
  var sql =
    "SELECT commodity_report.id as id,report1,report2,name,img_link,model,type FROM commodity_report JOIN commodity ON commodity.id=commodity_report.commodityid WHERE shopid='" +
    shopid +
    "'";
  console.log(sql);
  con.query(sql, function (err, result) {
